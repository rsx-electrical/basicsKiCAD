...
> If you have no idea how to do the previous 2 steps refer to: [KiCad_librar_setup](https://github.com/rsx-electrical/basicsKiCAD/blob/main/Kicad_library_setup.md)
